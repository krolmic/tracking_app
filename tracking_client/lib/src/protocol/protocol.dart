...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i3.MoodEntry>) {
      return (data as List).map((e) => deserialize<_i3.MoodEntry>(e)).toList()
          as dynamic;
    }
    if (t == _i1.getType<List<String>?>()) {
      return (data != null
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    if (data['className'] == 'MoodEntry') {
      return deserialize<_i2.MoodEntry>(data['data']);
    }
