    ...
    'en': '''
      <body>
        <div class="container">
            ...
            <p>Last updated: 22nd August 2024</p>

            <h2>1. Acceptance of Terms</h2>
            <p>By accessing or using the Healthy Hustle ("App"), you agree to be bound by these Terms of Service ("Terms").
                If
                you do not agree to these Terms, please do not use the App.</p>

            <h2>2. Description of Service</h2>
            <p>The App provides users with tools to track mood entries (consising of mood, record affirmations - things
                users are grateful for, work time and revenue). User
            ...
            <ul>
                <li><strong>User Account Data:</strong> Stored by AWS Amplify in AWS Cognito hosted in Virginia, US. This
                    includes information such as your email address and first name.</li>
                <li><strong>Mood Entries:</strong> Stored on an AWS EC2 instance using PostgreSQL hosted in Virginia, US.
                    This
                    includes estimated mood, 3 affirmations - things users are grateful for, work time, and revenue that
                    users can save on daily basis.
                </li>
            </ul>
            ...
            <p>Logged-in users can access, correct, or delete their data (including user account data, first name, mood
                entries, affirmations - things users are grateful for, work time and revenue) within the App.</p>
            ...
            <ul>
                ...
                <li><strong>AWS EC2:</strong> Used to host the server instance connected with PostgreSQL for storing mood
                    entries
                    data.</li>
            </ul>
    ...
    'de': '''
      <body>
        <div class="container">
            ...
            <p>Zuletzt aktualisiert: 22. August 2024</p>

            <h2>1. Annahme der Bedingungen</h2>
            <p>Durch den Zugriff auf oder die Nutzung von Healthy Hustle ("App") stimmen Sie zu, an diese
                Nutzungsbedingungen
                ("Bedingungen") gebunden zu sein. Wenn Sie diesen Bedingungen nicht zustimmen, nutzen Sie die App bitte
                nicht.</p>

            <h2>2. Beschreibung des Dienstes</h2>
            <p>Die App bietet Nutzern Werkzeuge zur Stimmungsverfolgung, zum Aufzeichnen von Affirmationen, Arbeitszeit und
                Umsatzes. Benutzerdaten und Stimmungseinträge werden sicher auf AWS-Diensten gespeichert.</p>
            ...
            <ul>
                <li><strong>Benutzerkontodaten:</strong> Gespeichert von AWS Amplify in AWS Cognito in Virginia, USA. Dazu
                    gehören Informationen wie Ihre E-Mail-Adresse und Ihr Vorname.</li>
                <li><strong>Stimmungseinträge:</strong> Gespeichert auf einer AWS PostgreSQL Instanz in Virginia, USA.
                    Dazu gehören geschätzte Stimmung, 3 Affirmationen, Arbeitszeit und Umsatz, die Benutzer täglich
                    speichern können.</li>
            </ul>
            ...
            <p>Eingeloggte Benutzer können auf ihre Daten zugreifen, diese korrigieren oder löschen (einschließlich
                Benutzerkontodaten, Vorname, Stimmungseinträge, Affirmationen, Arbeitszeit und Umsatz) innerhalb der App.
            </p>
            ...
            <ul>
                ...
                <li><strong>AWS EC2:</strong> Wird verwendet, um den Server, verbunden mit PostgreSQL für die Speicherung
