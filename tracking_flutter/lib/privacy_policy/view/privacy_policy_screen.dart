    ...
    'en': '''
      <body>
        <div class="container">
            ...
            <p>This Privacy Policy explains how the Healthy Hustle ("App") collects, uses, and protects your information
                when
            ...
            <ul>
                <li><strong>User Account Data:</strong> Information such as your email address and first name, stored by AWS
                    Amplify in AWS Cognito hosted in Virginia, US.</li>
                <li><strong>Mood Entries:</strong> Information such as estimated mood, 3 affirmations, work time and revenue
                    entries which users are able to save on daily basis,
                    stored in a PostgreSQL instance hosted in Virginia, US.</li>
            </ul>
            ...
            <p>You have the right to access, correct, or delete your data within the App. Logged-in users can manage their
                data (including user account data, first name, mood entries including mood estmation, affirmations, work
                time and revenue) within the
                App.</p>
    ...
    'de': '''
      <body>
        <div class="container">
            ...
            <h2>1. Einführung</h2>
            <p>Diese Datenschutzerklärung erklärt, wie Healthy Hustle ("App") Ihre Informationen sammelt, verwendet und
            ...
            <ul>
                <li><strong>Benutzerkontodaten:</strong> Informationen wie Ihre E-Mail-Adresse und Ihren Vornamen,
                    gespeichert von AWS Amplify in AWS Cognito in Virginia, USA.</li>
                <li><strong>Stimmungseinträge:</strong> Informationen wie geschätzte Stimmung, 3 Affirmationen, Arbeitszeit
                    und Umsatz, gespeichert auf einer PostgreSQL-Instanz in Virginia, USA.</li>
            </ul>
            ...
            <p>Sie haben das Recht, innerhalb der App auf Ihre Daten zuzugreifen, diese zu korrigieren oder zu löschen.
                ...
                Affirmationen, Arbeitszeit und Umsatz) innerhalb der App verwalten.</p>
